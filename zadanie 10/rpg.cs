...
namespace RPG_Gra___PP
{
  ...
  public class Warrior : Hero {
    public Warrior(string _Name){
      ...
      this.firstAbilityName = "Atak Mieczem";
      this.secondAbilityName = "Atak Buzdyganem";
      this.thirdAbilityName = "Pchnięcie";
      this.specialty = newRage();
      this.specialtyName = "Złość";
    }
    
    public override int newRage(){
  ...
  public class Assassin : Hero {
    public Assassin(string _Name){
      ...
      this.firstAbilityName = "Rzut Shurikenem";
      this.secondAbilityName = "Atak Krótkimi Mieczami";
      this.thirdAbilityName = "Podwójny atak";
      this.specialty = 100;
  ...
  public class Mage : Hero {
    public Mage(string _Name){
      ...
      this.Dexterity = 6;
      this.ClassName = "Mag";
      this.firstAbilityName = "Magiczny pocisk";
      this.secondAbilityName = "Kula ognia";
      this.thirdAbilityName = "Wzmocnienie";
      this.specialty = 100;
